...
Agora que o usuário pode selecionar uma casa, implemente, na função criada na tarefa anterior, o script necessário para preencher a casa selecionada com um X. Lembre-se que é possível acessar o elemento clicado com a variável _event_, passada na chamada da função, no elemento html.
